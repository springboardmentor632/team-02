// Extracted policy and scheme payloads for reuse by seed scripts
module.exports = {
  policies: [
    {
    ...
    },
    {
      ...
      summary: 'A government-backed pension scheme targeting unorganized sector workers, guaranteeing a monthly pension of ₹1000 to ₹5000 after age 60.',
      content: 'APY is administered by PFRDA. Subscribers choose a monthly contribution amount based on age and desired pension. The government co-contributes for eligible subscribers in the first five years. Surviving spouses continue to receive the same pension.',
      status: 'Active',
      state: 'All India',
      publishedAt: new Date('2015-06-01').toISOString(),
    ...
    },
    {
      ...
      summary: 'A programme to build highways and freight corridors that improve road transport efficiency across India.',
      content: 'Bharatmala focuses on upgrading national highways, building economic corridors, and developing logistics parks to lower freight costs and improve connectivity.',
      status: 'Active',
      state: 'All India',
      publishedAt: new Date('2017-05-01').toISOString(),
      tags: ['infrastructure', 'transport', 'logistics'],
    },
    {
      ...
      summary: 'Develop 100 smart cities with modern urban infrastructure, technology, and citizen services.',
      content: 'The mission improves urban mobility, waste management, water supply, and digital citizen services through integrated infrastructure and smart governance.',
      status: 'Active',
      state: 'All India',
      publishedAt: new Date('2015-06-25').toISOString(),
      tags: ['urban', 'technology', 'infrastructure'],
    },
    {
      ...
      summary: 'Reduce air pollution in major cities with source-focused interventions and monitoring.',
      content: 'NCAP sets targets for particulate matter reduction in key cities, expands air quality monitoring, and supports cleaner fuels and transport systems.',
      status: 'Active',
      state: 'All India',
      publishedAt: new Date('2019-01-10').toISOString(),
      tags: ['environment', 'air quality', 'health'],
    },
    {
      title: 'National Disaster Resilience Policy',
      category: 'Disaster Management',
      ministry: 'Ministry of Home Affairs',
      department: 'National Disaster Management Authority',
      summary: 'Strengthen India’s resilience to natural disasters through preparedness, mitigation, and rapid recovery.',
      content: 'The policy establishes guidelines for disaster risk reduction, emergency response planning, early warning systems, and community training. It encourages state-level action plans, resilient infrastructure design, and capacity building for local authorities.',
      status: 'Active',
      state: 'National',
      publishedAt: new Date('2024-01-10').toISOString(),
      tags: ['disaster management', 'resilience', 'emergency response'],
    }
  ],
  schemes: [
    {
    ...
    },
    {
      ...
      details: 'PMSBY is an accidental insurance scheme offering Rs 2 lakh for accidental death or total disability and Rs 1 lakh for partial disability. Annual premium is Rs 20, auto-debited from the bank account. The scheme is available through partner banks and can be renewed annually. Any Indian with a savings bank account aged 18-70 can enroll.',
      status: 'Active',
      state: 'National',
